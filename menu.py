        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items.keys():
                    ...
                    quantity = input(f"""Type the quantity of {menu_item_name} you would like:
Quantity will default to 1 if you input is invalid
""")
    ...
    while True:
        ...
        match keep_ordering.lower():
            ...
            case _:
                ...
                print("Try again because you didn't type a valid input")
...
print(f"""
Here\'s your total price: ${sum(prices)}""")